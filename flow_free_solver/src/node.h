...
typedef struct tree_node_struct {
	...
	struct tree_node_struct* up;
	struct tree_node_struct* down;
} tree_node_t;
...
tree_node_t* node_create(tree_node_t* parent, const game_info_t* info, const game_state_t* state, int direction);
...
//////////////////////////////////////////////////////////////////////
// Frees the tree of nodes from the root recursively.
