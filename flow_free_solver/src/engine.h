...
int game_num_free_coords_dead(const game_info_t* info, const game_state_t* state, int x, int y);
...
int game_num_free_pos_dead(const game_info_t* info, const game_state_t* state, pos_t pos);
